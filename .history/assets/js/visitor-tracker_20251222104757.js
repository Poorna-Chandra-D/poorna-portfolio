...
(function() {
    ...
    function sendTrackerData(data) {
        ...
        // Option 2: Send to Discord Webhook (uncomment to use)
        // sendToDiscord(data);
        
        // Option 3: Send to Email (uncomment to use)
        // sendToEmail(data);
    }
    ...
    function sendToTelegram(data) {
        ...
        if (BOT_TOKEN === 'YOUR_TELEGRAM_BOT_TOKEN') {
            console.log('⚠️ Telegram not configured. Visit tracker.html for setup instructions.');
            return;
        }
...
📐 *Screen:* ${data.screenResolution}
    ...
    function sendToEmail(data) {
        const FORMSPREE_ID = 'YOUR_FORMSPREE_ID'; // Replace with formspree ID or use EmailJS
